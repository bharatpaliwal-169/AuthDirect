      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12 col-md-10">
            ...
            <h4 class="text-success-emphasis">Don't remeber your password... </h4>
            <h4>NO worries we will help you with new password setting</h4>
            <p class="text-muted">Please click on the below link to go back to your account.</p>
            <a href="http://localhost:5000/api/v2/auth/changepassword/?token=${TOKEN}" class="text-bg-primary link-underline">verify my email</a>
          </div>
        </div>
        <div class="row">
          <h4 class="display-6">
