    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-12 col-md-10 text-center justify-center">
          <h1 class="display-5">Welcome to AuthDirect</h1>
          <p class="">Please click on the below link to verify your email.</p>
          <a href="http://localhost:5000/api/v2/auth/verification/?token=${TOKEN}" class="text-bg-primary link-underline">verify my email</a>
        </div>
      </div>
      <div class="row">
        <h4 class="display-6">
          AuthDirect Saas product that caters all you authencation related requirements.
        </h4>
